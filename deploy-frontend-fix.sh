...
# Deploy Frontend Fixes (Port + CSS)
echo "🚀 Deploying frontend accessibility and CSS fixes..."

# Push changes to GitHub
echo "📤 Pushing changes to GitHub..."
git add frontend/vite.config.ts frontend/tailwind.config.js frontend/src/index.css docker-compose.yml
git commit -m "Fix frontend: port mapping, host binding, and missing Tailwind CSS classes"
