...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E27] flex items-center justify-center p-4 py-8 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-[#1A1F3A]/80 border-[#FFD700]/30 backdrop-blur-md relative z-10 shadow-2xl shadow-black/50">
        <CardHeader className="text-center pb-6">
          <div className="w-24 h-24 bg-gradient-to-br from-[#FFD700] to-[#FFA500] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-[#FFD700]/20 ring-4 ring-[#0A0E27]/50">
            <UserPlus className="w-12 h-12 text-[#0A0E27]" />
          </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-[#0A0E27]/50 border-[#FFD700]/30 text-white placeholder:text-gray-500 focus:border-[#FFD700] focus:ring-[#FFD700] pr-12 h-11 text-lg"
                  required
                  minLength={8}
            ...
            <div className="space-y-2">
              ...
              />
              {referralCode && (
                <p className="text-xs text-[#00F5FF] animate-pulse">
