    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-royal-medium border border-gold/20 rounded-xl p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-5 gap-2">
                {quickAmounts.map((amt) => (
                  <button
                    ...
                    className="px-3 py-2 bg-royal-dark border border-gold/20 rounded-lg text-gold hover:border-gold/50 hover:bg-royal-dark/80 transition-all text-sm"
                  >
                    ₹{amt}
                  </button>
                ))}
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gold/30 rounded-xl p-6 text-center hover:border-gold/50 transition-all">
                {screenshotPreview ? (
                  ...
                  <label className="cursor-pointer">
                    <Upload className="w-12 h-12 text-gold/50 mx-auto mb-3" />
                    <p className="text-gold mb-1">Click to upload screenshot</p>
                    <p className="text-gold/50 text-sm">PNG, JPG up to 5MB</p>
                    <input
                      type="file"
                      accept="image/*"
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-gold to-gold/80 text-royal-dark rounded-xl font-bold text-lg hover:from-gold/90 hover:to-gold/70 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="space-y-4">
          {/* UPI Details */}
          <div className="bg-royal-medium border border-gold/20 rounded-xl p-5">
            ...
            <div className="space-y-3">
              <div>
                <p className="text-gold/70 text-sm mb-1">UPI ID</p>
                <div className="flex items-center gap-2 bg-royal-dark rounded-lg p-3">
                  <code className="text-gold flex-1 text-sm break-all">
                    {paymentSettings?.upiId || 'Loading...'}
                  </code>
                  <button
                    onClick={handleCopyUPI}
                    className="p-2 hover:bg-royal-medium rounded-lg transition-all"
                  >
                    {copied ? (
          ...
          <div className="bg-royal-medium border border-gold/20 rounded-xl p-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 bg-royal-dark rounded-lg p-3">
                <code className="text-gold flex-1 text-sm">
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-xl p-5">
            <h3 className="text-gold font-bold mb-2">🎁 Deposit Bonus</h3>
            <p className="text-gold/70 text-sm">
              Get <span className="text-purple-400 font-bold">5% bonus</span> on every deposit! 
