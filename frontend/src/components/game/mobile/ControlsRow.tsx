  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <button
        ...
        className="flex-1 h-11 bg-navy-light/80 rounded-lg flex flex-col items-center justify-center border border-navy-light hover:border-gold/50 transition-all duration-200 active:scale-95"
      >
        <svg 
      ...
      <button
        ...
        className="flex-1 h-11 bg-navy-light/80 rounded-lg flex flex-col items-center justify-center border border-navy-light hover:border-gold/50 transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg 
          className="w-4 h-4 text-gray-400" 
          fill="none" 
      ...
      <button
        ...
        className="flex-1 h-11 bg-gradient-to-r from-gold to-gold/80 rounded-full flex items-center justify-center border-2 border-gold/80 shadow-lg hover:shadow-gold/25 transition-all duration-200 active:scale-95"
      >
        {selectedBetAmount > 0 ? (
